...
Hero.prototype.jump = function (jumpSpeed) {
    ...
    var canJump = this.body.touching.down && this.alive && !this.isFrozen;
...
HeroSelectState.update = function () {
    if (this.keys.left.isDown) {
        ...
        this.game.state.start('play', true, false, { level: 0, heroSelected: this.selected });
    }
}
...
},{"./heroselect.js":3,"./playstate.js":5}],5:[function(require,module,exports){
'use strict';
...
PlayState._setupEndLevel = function () {
...
PlayState._onHeroVsCoin = function (hero, coin) {
  ...
  if (this.coinPickupCount === 2) {
    ...
    if (this.platformsToBeDisabled.length > 0) {
      this.platformsToBeDisabled.forEach((platform) => platform.body.enable = false)
    }
  }
};
...
PlayState._onHeroVsEnemy = function (hero, enemy) {
  ...
  if (hero.body.velocity.y > 0) {
    ...
    hero.events.onKilled.addOnce(function () {
      this.game.coins -= this.coinPickupCount;
      this.game.state.restart(true, false, { level: this.level, heroSelected: this.heroSelected });
    }, this);
...
PlayState._spawnPlatform = function (platform) {
  ...
  if (platform.willBeDisabled) {
    this.platformsToBeDisabled.push(sprite)
  }
...
},{"./daycycle.js":1,"./hero.js":2,"./spider.js":6}],6:[function(require,module,exports){
'use strict';
...
Spider.prototype.update = function () {
    ...
    if (this.body.touching.right || this.body.blocked.right) {
        this.body.velocity.x = -SPEED; // turn left
    }
    else if (this.body.touching.left || this.body.blocked.left) {
        this.body.velocity.x = SPEED; // turn right
    }
};
